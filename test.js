...
//     console.log(integralOf(functionDatabase[i]))
//     console.log(integralOf(integralOf(functionDatabase[i])));
    
//     console.log(compareIntegrals(integralOf(integralOf(functionDatabase[i])), integralOf(functionDatabase[i])));
// }

console.log(integralOf('2x^4-x^2+x'));
